...
![Prefacio](../img/00-preface.png)

**Autor**: Ricardo (con Claude)
**Fecha**: 2025-12-24
...
Este documento fue escrito en colaboración entre un humano (Ricardo) y una inteligencia artificial (Claude). Lo revelamos no como decoración sino porque importa: la filosofía de Naur, formulada hace cuarenta años, ofrece una guía inesperadamente precisa para esta nueva forma de colaboración.

Si programar es construir teoría, y la teoría vive en las mentes, la pregunta para nuestra era es: ¿puede una IA participar en esa construcción? Nuestra experiencia sugiere que sí—pero con protocolos que tomen en cuenta una asimetría fundamental: el humano recuerda; la IA olvida. De esa asimetría emerge una práctica.
