...
This document was written in collaboration between a human (Ricardo) and an AI (Claude). We reveal this not as decoration but because it matters: Naur's philosophy, formulated forty years ago, offers unexpectedly precise guidance for this new form of collaboration.

If programming is theory building, and theory lives in minds, the question for our era is: can an AI participate in that construction? Our experience suggests yes—but with protocols that account for a fundamental asymmetry: the human remembers; the AI forgets. From that asymmetry emerges a practice.
